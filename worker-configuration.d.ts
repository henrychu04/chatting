/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 86da72a15099f955d1ca7a4eb4fc29ee)
...
declare namespace Cloudflare {
	interface Env {
		...
		FACET: DurableObjectNamespace<import("./workers/app").Facet>;
		DB: D1Database;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "BETTER_AUTH_SECRET" | "BETTER_AUTH_URL" | "DATABASE_URL" | "NODE_ENV" | "LOG_LEVEL" | "RATE_LIMIT_MESSAGES_PER_MINUTE" | "RATE_LIMIT_AUTH_PER_MINUTE">> {}
}
